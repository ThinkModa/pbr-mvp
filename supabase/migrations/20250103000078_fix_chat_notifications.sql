-- Fix chat notifications to handle null event_id
-- Migration: 20250103000078_fix_chat_notifications.sql

-- 1. Update create_chat_notification function to handle null event_id
...
-- 2. Update create_chat_thread_notification function to handle null event_id
...
COMMENT ON FUNCTION create_chat_notification() IS 'Creates notifications for new chat messages - handles null event_id';
COMMENT ON FUNCTION create_chat_thread_notification() IS 'Creates notifications for new chat threads - handles null event_id';
