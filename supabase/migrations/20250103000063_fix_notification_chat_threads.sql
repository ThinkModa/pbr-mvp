-- Fix notification system to create chat threads for notifications
-- Migration: 20250103000063_fix_notification_chat_threads.sql

-- Update send_notification_to_rsvps function to create notification chat threads
...
COMMENT ON FUNCTION send_notification_to_rsvps IS 'Creates a notification and a corresponding chat thread for event attendees';
